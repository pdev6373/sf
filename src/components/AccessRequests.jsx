...
import styles from "../app/styles/accessRequests.module.scss";
              ...
              <div className={styles.bottom}>
                <div className={styles.header}>
                  ...
                  <div className={styles.third}>
                    <h1>Access Start Date</h1>
                  </div>
                  <div className={styles.fourth}>
                    <h1>Access End Date</h1>
                  </div>
                ...
                {!data?.message ? (
                  data?.map((dat, index) => (
                    <div className={styles.list} key={dat.id}>
                      <div className={styles.first}>
                      ...
                      <div className={styles.second}>
                        <h1>{dat.locationTitle}</h1>
                      </div>
                      <div className={styles.third}>
                        <h1>{dat.accessStartDate}</h1>
                      </div>
                      <div className={styles.fourth}>
                        <h1>{dat.accessEndDate}</h1>
                      </div>
                    </div>
                  ))
                ) : (
                ...
                <div className="flex-1 flex flex-col w-full px-2 py-2 gap-y-4">
                  ...
                  <div className="flex-1 flex flex-col ">
                    ...
                    <div className="text-xs">
                      Res ipsa loquitur is a Latin phrase that translates to
                      “the thing speaks for itself” . It is a legal doctrine
                      that refers to situations where the facts of a case are so
                      obvious that they speak for themselves, and no further
                      explanation is needed . This doctrine is often used in
