  ...
  console.log(id)
    ...
    const fetchQuery = async (url) => {
      ...
      const { data: profile, error: profileError, isLoading: isprofileLoading, isFetched: isprofileFetched } = useQuery({
        ...
        queryFn: () => fetchQuery(`https://api-tracker.dev.dangote.islands.digital/Users/${id}`),
    });
            ...
            <div className='flex justify-between items-center px-4 pt-6'>
                ...
                <div className='flex items-center gap-10'>
                    <div className='flex flex-col items-center gap-2'>
                        <div className='bg-[#E60E0E] w-[134px] h-[40px] flex justify-center items-center text-[#FFFBFB] text-xs font-bold'>SECURITY STAFF</div>
